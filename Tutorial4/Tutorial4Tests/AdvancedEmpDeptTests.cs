...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnFirstTwoHiredEmployees()
    {
        ...
        var firstTwo = (from emp in emps
                orderby emp.HireDate ascending select emp).Take(2).ToList(); 
    ...
    public void ShouldReturnEmployeesWithManagers()
    {
        ...
        var withMgr = (from emp in emps
            where emp.Mgr is not null select emp);
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = from emp in emps
            ...
            join grade in grades on true equals true
            where emp.Sal >= grade.Losal && emp.Sal <= grade.Hisal
            select new { emp.EName, dept.DName, grade.Grade };    
